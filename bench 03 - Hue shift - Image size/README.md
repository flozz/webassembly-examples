# Benchmark 03 - Hue shift - Image size

This benchmark mesure the speed difference between a pure JavaScrupt and a WebAssembly versions of a hue shift on a canvas with different image size.
...
* `images/*.jpg`: The images that will be modified by the JS and the WASM.
